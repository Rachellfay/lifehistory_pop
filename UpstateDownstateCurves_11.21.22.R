...
# Culex pipiens mosquito populations from NYS

# originally adapted from Shocket et al. 2020
# Author: R. L. Fay <RachelLFay@gmail.com> and A.C. Keyel <akeyel@albany.edu>
